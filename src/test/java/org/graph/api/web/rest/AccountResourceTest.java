...
import org.graph.api.Application;
...
import org.graph.api.security.AuthoritiesConstants;
import org.graph.api.service.MailService;
import org.graph.api.service.UserService;
import org.graph.api.web.rest.dto.UserDTO;
...
public class AccountResourceTest {
    ...
    public void setup() {
        ...
        doNothing().when(mockMailService).sendActivationEmail((GUser) anyObject(), anyString());
    ...
    public void testRegisterValid() throws Exception {
        ...
        GUser user = userRepository.findOneByLogin("joe");
    ...
    public void testRegisterInvalidLogin() throws Exception {
        ...
        GUser user = userRepository.findOneByEmail("funky@example.com");
    ...
    public void testRegisterInvalidEmail() throws Exception {
        ...
        GUser user = userRepository.findOneByLogin("bob");
        assertThat(user).isNull();
    }
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        GUser userDup = userRepository.findOneByEmail("alicejr@example.com");
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        GUser userDup = userRepository.findOneByLogin("johnjr");
        assertThat(userDup).isNull();
    }
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        GUser userDup = userRepository.findOneByLogin("badguy");
