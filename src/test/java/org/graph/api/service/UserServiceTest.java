...
public class UserServiceTest {
    ...
    public void assertThatUserMustExistToResetPassword() {
        ...
        GUser user = userService.requestPasswordReset("john.doe@localhost");
    ...
    public void assertThatResetKeyMustNotBeOlderThan24Hours() {
        ...
        GUser user = userService.createUserInformation("johndoe", "johndoe", "John", "Doe", "john.doe@localhost", "en-US");
        ...
        GUser maybeUser = userService.completePasswordReset("johndoe2", user.getResetKey());
    ...
    public void testFindNotActivatedUsersByCreationDateBefore() {
        ...
        List<GUser> users = userRepository.findAllByActivatedIsFalseAndCreatedDateBefore(now.minusDays(3));
