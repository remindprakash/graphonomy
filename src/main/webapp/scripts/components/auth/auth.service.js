...
angular.module('testapp2App')
    .factory('Auth', function Auth($location,$rootScope, $state, $q, $translate, Principal, AuthServerProvider, Account, Register, Activate, Password, PasswordResetInit, PasswordResetFinish) {
        return {
