...
public class AccountResource {
	...
	public ResponseEntity<?> registerAccount(
		...
		if (user != null) {
			...
			user = userService.createUserInformation(userDTO.getLogin(),
					userDTO.getPassword(), userDTO.getCompanyName(), userDTO
							.getFirstName(), userDTO.getLastName(), userDTO
							.getEmail().toLowerCase(), userDTO.getLangKey());
	...
	public ResponseEntity<UserDTO> getAccount() {
		...
		return new ResponseEntity<>(new UserDTO(user.getLogin(), null,
				user.getFirstName(), user.getLastName(), user.getEmail(),
				user.getLangKey(), roles), HttpStatus.OK);
	}
	...
	public ResponseEntity<String> saveAccount(@RequestBody UserDTO userDTO) {
		User userHavingThisLogin = userRepository.findOneByLogin(userDTO
				.getLogin());
		if (userHavingThisLogin != null
				&& !userHavingThisLogin.getLogin().equals(
	...
	public ResponseEntity<?> requestPasswordReset(@RequestBody String mail,
		...
		if (user != null) {
			...
			return new ResponseEntity<>("e-mail address not registered",
