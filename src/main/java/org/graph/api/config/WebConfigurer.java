...
import org.graph.api.web.filter.CachingHttpHeadersFilter;
import org.graph.api.web.filter.StaticResourcesProductionFilter;
import org.graph.api.web.filter.gzip.GZipServletFilter;
 ...
 */
@Configuration
@PropertySource({"classpath:config/${env:dev}/db.properties"})
